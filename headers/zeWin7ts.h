...
zval *zend_get_zval_ptr(const zend_op *opline, int op_type, const znode_op *node, const zend_execute_data *execute_data, zend_free_op *zval, int number);
...
php_stream *_php_stream_fopen_from_fd(int fd, const char *mode, ...);
